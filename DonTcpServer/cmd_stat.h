...
#ifndef COMMAND_STAT_H
#define COMMAND_STAT_H
...
class CCommand_Stat : public CCommandObject
{
public:
	CCommand_Stat(char* szName, void* pHost, std::vector<std::string>& cmds, int nThreadCount, int nMillisecInterval) :
