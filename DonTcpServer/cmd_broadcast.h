...
class CCommand_Broadcast : public CCommandObject
{
public:
	CCommand_Broadcast(char* szName, void* pHost, std::vector<std::string>& cmds, int nThreadCount, int nMillisecInterval) :
